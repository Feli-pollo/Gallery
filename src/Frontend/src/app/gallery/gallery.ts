...
export class Gallery {
  ...
  constructor(private searchService: SearchService) {
    ...
    this.pokeListFull = [...this.pokeList];
  }

  findSearch(searchName: string) {
    this.pokeList = [...this.pokeListFull];
    this.pokeList = this.pokeListFull.filter(poke => poke.nombre.toLowerCase().includes(searchName.toLowerCase()));
  }
